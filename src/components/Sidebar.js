  ...
  render() {
    ...
    return (
      <section>
        ...
        <div className="icons">
          <a href="https://drive.google.com/file/d/1McgEcEjh4SeRsRDJSLmZmLEX90XWee-3/view?usp=sharing" target="_blank" rel="noopener noreferrer"><img width="50em" height="50em" src={resume} alt="resume"></img></a>
